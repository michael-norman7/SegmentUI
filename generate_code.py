...
def generate_base_structure(masked_image_path, output_dir, num_components):
            ...
            "content": [
                {
                    ...
                    "text": (
                        ...
                        "and inserted into it later. Use placeholder divs with IDs like 'component_0', 'component_1', etc., "
                        f"up to 'component_{num_components - 1}'."
                    ),
                },
                {
                    "type": "image_url",
    ...
    # Save the base HTML structure
    base_html_path = os.path.join(output_dir, "base_structure.html")
    with open(base_html_path, "w") as file:
        file.write(base_structure_code)
    print(f"Base structure saved to {base_html_path}")
    return base_html_path
...
def main():
    ...
    base_html_path = generate_base_structure(
